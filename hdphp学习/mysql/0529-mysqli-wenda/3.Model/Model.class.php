...
class Model{
	...
	private function error($sql){
		if(self::$link->errno){
			echo "错误信息：" . self::$link->error . '<br/>';
			echo "<span style='color:red'>错误的SQL：" . $sql . '</span>';
			die;
		}
	}
...
//插入
//$id = M()->exec("INSERT INTO article SET title='test'");
//if($id){
//	echo 'ok';
//}else{
//	echo '不ok';
...
//删除
M()->exec("DELETE FROM article WHERE title='test'");
