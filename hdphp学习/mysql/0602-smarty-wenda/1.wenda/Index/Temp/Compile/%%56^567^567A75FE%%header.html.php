<?php /* Smarty version 2.6.26, created on 2015-06-02 14:53:35
...
<?php $this->_cache_serials['D:/wamp/www/c49/mysql/0602/1.wenda/Index/Temp/Compile\%%56^567^567A75FE%%header.html.inc'] = '040972044779a2c2ad274c0f1f19a91e'; ?>	<link rel="stylesheet" href="<?php echo @__PUBLIC__; ?>
/Css/common.css" />
...
<body>
	...
	<div id='top-bar'>
		...
		<ul class='top-bar-right fr'>
			<?php if ($this->caching && !$this->_cache_including): echo '{nocache:040972044779a2c2ad274c0f1f19a91e#0}'; endif;$this->_tag_stack[] = array('nocache', array()); $_block_repeat=true;nocache($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
?c=Public&a=out">退出</a></li> 
			...
			<?php endif; ?>
			<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo nocache($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); if ($this->caching && !$this->_cache_including): echo '{/nocache:040972044779a2c2ad274c0f1f19a91e#0}'; endif;?>
		</ul>
	</div>
<!-- 提问搜索框 -->
	<div id='search'>
