...
class Code{
	...
	public function __construct($width=NULL,$height=30,$codeLen=NULL,$fontSize=16,$bgColor=NULL,$seed='1234567890qwertyuiopasdklzxcvbnm'){
		//宽度
		...
		//字体文件
		$this->fontFile = FONT_PATH . "/font.ttf";
		//种子
		$this->seed = $seed;
	}
	/**
